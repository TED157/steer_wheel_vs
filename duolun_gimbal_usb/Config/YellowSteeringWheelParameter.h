...
#define AMMO_SPEEDSET_30MS_L                    7060//7400//7800
#define AMMO_SPEEDSET_30MS_R                    7060

#define ROTOR_SPEEDSET_FORWARD                  4650.0f//5000.0f//5000
...
#define ROTOR_FORWARD_ANGLE_KP                  120.0f//150f
#define ROTOR_FORWARD_ANGLE_KI                  0.0f
#define ROTOR_FORWARD_ANGLE_KD                  15.0f
fp32 ROTOR_FORWARD_ANGLE[3] = { ROTOR_FORWARD_ANGLE_KP, ROTOR_FORWARD_ANGLE_KI, ROTOR_FORWARD_ANGLE_KD };
...
//  PITCH轴角速度环
#define PITCH_SPEED_RESET_POSITION_KP           0.0210f//50.0f
...
#define PITCH_ANGLE_RESET_POSITION_KP           22.0f//2.0f
#define PITCH_ANGLE_RESET_POSITION_KI           0.0072f//0.5f
#define PITCH_ANGLE_RESET_POSITION_KD           0.0065f
...
#define YAW_SPEED_MANUAL_OPERATE_KI             0.0f//0
...
//  PITCH轴角度环
#define PITCH_ANGLE_MANUAL_OPERATE_KP           30.0f//40.0f
#define PITCH_ANGLE_MANUAL_OPERATE_KI           0.0072f//0.045f
#define PITCH_ANGLE_MANUAL_OPERATE_KD          100.0f//20.0f
...
//  yaw轴自动转180度
//  YAW轴角速度环
#define YAW_SPEED_AUTO_REVERSE_OPERATE_KP             1000.0f//360.0f
#define YAW_SPEED_AUTO_REVERSE_OPERATE_KI             0.0f//0
#define YAW_SPEED_AUTO_REVERSE_OPERATE_KD             0.0f
fp32 YAW_SPEED_AUTO_REVERSE_OPERATE[3] = { YAW_SPEED_AUTO_REVERSE_OPERATE_KP, YAW_SPEED_AUTO_REVERSE_OPERATE_KI, YAW_SPEED_AUTO_REVERSE_OPERATE_KD };
//  YAW轴角度环
#define YAW_ANGLE_AUTO_REVERSE_OPERATE_KP             12.0f//40.0f
#define YAW_ANGLE_AUTO_REVERSE_OPERATE_KI             0.0001f//0.015f,wyf:0.02
#define YAW_ANGLE_AUTO_REVERSE_OPERATE_KD             0.0f//40.0f
fp32 YAW_ANGLE_AUTO_REVERSE_OPERATE[3] = { YAW_ANGLE_AUTO_REVERSE_OPERATE_KP, YAW_ANGLE_AUTO_REVERSE_OPERATE_KI, YAW_ANGLE_AUTO_REVERSE_OPERATE_KD };


//  自瞄控制云台参数
//  YAW轴角速度环
#define YAW_SPEED_AIMBOT_OPERATE_KP             360.0f//360
#define YAW_SPEED_AIMBOT_OPERATE_KI             0.00f//0.1f
#define YAW_SPEED_AIMBOT_OPERATE_KD             0.2f
fp32 YAW_SPEED_AIMBOT_OPERATE[3] = { YAW_SPEED_AIMBOT_OPERATE_KP, YAW_SPEED_AIMBOT_OPERATE_KI, YAW_SPEED_AIMBOT_OPERATE_KD };
//  YAW轴角度环
#define YAW_ANGLE_AIMBOT_OPERATE_KP             11.3f//19.0f//25.0f//36.0f
#define YAW_ANGLE_AIMBOT_OPERATE_KI             0.00f//0.0f// 0.015f
#define YAW_ANGLE_AIMBOT_OPERATE_KD             270.5f//70.0f//2.0f//25.0f
fp32 YAW_ANGLE_AIMBOT_OPERATE[3] = { YAW_ANGLE_AIMBOT_OPERATE_KP, YAW_ANGLE_AIMBOT_OPERATE_KI, YAW_ANGLE_AIMBOT_OPERATE_KD };
//  PITCH轴角速度环
#define PITCH_SPEED_AIMBOT_OPERATE_KP           0.0182f//0.018f
...
//  PITCH轴角度环
#define PITCH_ANGLE_AIMBOT_OPERATE_KP           15.3f//20.0f
#define PITCH_ANGLE_AIMBOT_OPERATE_KI           0.0072f
#define PITCH_ANGLE_AIMBOT_OPERATE_KD           0.21//0.800f
...
//  打符云台参数
//  YAW轴角速度环
#define YAW_SPEED_AIMBOT_RUNES_KP               450.0f
...
//  YAW轴角度环
#define YAW_ANGLE_AIMBOT_RUNES_KP               27.0f//24.0f//36.0f
#define YAW_ANGLE_AIMBOT_RUNES_KI               0.0020f//0.0f// 0.015f
#define YAW_ANGLE_AIMBOT_RUNES_KD               330.5f//2.0f//25.0f
fp32 YAW_ANGLE_AIMBOT_RUNES[3] = { YAW_ANGLE_AIMBOT_RUNES_KP, YAW_ANGLE_AIMBOT_RUNES_KI, YAW_ANGLE_AIMBOT_RUNES_KD };
//  PITCH轴角速度环
#define PITCH_SPEED_AIMBOT_RUNES_KP             0.0270f//0.019
...
//  PITCH轴角度环
#define PITCH_ANGLE_AIMBOT_RUNES_KP             24.0f
#define PITCH_ANGLE_AIMBOT_RUNES_KI             0.0072f
#define PITCH_ANGLE_AIMBOT_RUNES_KD             250.0f
...
#define PITCH_ANGLE_MANUAL_OPERATE_KD           20.0f//20.0f
fp32 PITCH_ANGLE_MANUAL_OPERATE[3] = { PITCH_ANGLE_MANUAL_OPERATE_KP, PITCH_ANGLE_MANUAL_OPERATE_KI, PITCH_ANGLE_MANUAL_OPERATE_KD };
...
fp32 YAW_SPEED_AIMBOT_OPERATE[3] = { YAW_SPEED_AIMBOT_OPERATE_KP, YAW_SPEED_AIMBOT_OPERATE_KI, YAW_SPEED_AIMBOT_OPERATE_KD };
//  YAW轴角度环
#define YAW_ANGLE_AIMBOT_OPERATE_KP             10.0f//25.0f//36.0f
#define YAW_ANGLE_AIMBOT_OPERATE_KI             0.00f//0.0f// 0.015f
#define YAW_ANGLE_AIMBOT_OPERATE_KD             140.0f//2.0f//25.0f
fp32 YAW_ANGLE_AIMBOT_OPERATE[3] = { YAW_ANGLE_AIMBOT_OPERATE_KP, YAW_ANGLE_AIMBOT_OPERATE_KI, YAW_ANGLE_AIMBOT_OPERATE_KD };
//  PITCH轴角速度环
...
fp32 YAW_SPEED_AIMBOT_RUNES[3] = { YAW_SPEED_AIMBOT_RUNES_KP, YAW_SPEED_AIMBOT_RUNES_KI, YAW_SPEED_AIMBOT_RUNES_KD };
//  YAW轴角度环
#define YAW_ANGLE_AIMBOT_RUNES_KP               15.3f//24.0f//36.0f
#define YAW_ANGLE_AIMBOT_RUNES_KI               0.0020f//0.0f// 0.015f
#define YAW_ANGLE_AIMBOT_RUNES_KD               270.5f//2.0f//25.0f
fp32 YAW_ANGLE_AIMBOT_RUNES[3] = { YAW_ANGLE_AIMBOT_RUNES_KP, YAW_ANGLE_AIMBOT_RUNES_KI, YAW_ANGLE_AIMBOT_RUNES_KD };
//  PITCH轴角速度环
#define PITCH_SPEED_AIMBOT_RUNES_KP             235.0f
#define PITCH_SPEED_AIMBOT_RUNES_KI             0.03f
#define PITCH_SPEED_AIMBOT_RUNES_KD             0.0f
fp32 PITCH_SPEED_AIMBOT_RUNES[3] = { PITCH_SPEED_AIMBOT_RUNES_KP, PITCH_SPEED_AIMBOT_RUNES_KI, PITCH_SPEED_AIMBOT_RUNES_KD };
//  PITCH轴角度环
#define PITCH_ANGLE_AIMBOT_RUNES_KP             15.7f
#define PITCH_ANGLE_AIMBOT_RUNES_KI             0.020f
#define PITCH_ANGLE_AIMBOT_RUNES_KD             210.0f
fp32 PITCH_ANGLE_AIMBOT_RUNES[3] = { PITCH_ANGLE_AIMBOT_RUNES_KP, PITCH_ANGLE_AIMBOT_RUNES_KI, PITCH_ANGLE_AIMBOT_RUNES_KD };
